                ...
                <tbody>
                    <%
                       ...
                       string institutionNo = Convert.ToString(Session["InstitutionNo"]);
                        var data = nav.LicenceApplicationHeader.Where(x=> x.Institution_No == institutionNo && x.Application_Status=="Closed" && x.Preliminary_Verdict=="Not Approved for Licensing").ToList();
                        int counter = 0;
