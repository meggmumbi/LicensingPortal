<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="ChangePassword.aspx.cs" Inherits="HRPortal.ChangePassword" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <div runat="server" id="changepasswordfeedback"></div>
        ...
        <div class="panel-footer">
            <asp:Button runat="server" ID="changepassword" CssClass="btn btn-success pull-right" Text="Change Password" OnClick="changepassword_Click"/>
