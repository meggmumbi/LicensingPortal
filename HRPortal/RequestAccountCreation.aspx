                            ...
                            <div class="panel">
                                <div style="padding: 20px;">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-lg-6">
                                            <div class="form-group">
                                                <label>Certicicate Type:</label>
                                                <asp:DropDownList runat="server" class="form-control select2" Style="width: 100%;" ID="certificateType" name="txtgender">
                                                    <asp:ListItem>--Select Certificate--</asp:ListItem>
                                                    <asp:ListItem Value="Certicicate of incorporation">Certicicate of incorporation</asp:ListItem>
